...
export const Popular: React.FC = () => {
  ...
  const { data, isLoading, isError, error, refetch } = usePopularMovies(page);
    ...
    <motion.div className="page-wrapper pt-20" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.4 }}>
      <div className="max-w-7xl mx-auto px-8 md:px-12 py-8">
        <div className="flex items-center gap-3 mb-8">
          <FiStar className="w-7 h-7 text-brand-red" />
          <h1 className="text-h1 font-bold text-white">Popular Movies</h1>
        </div>
