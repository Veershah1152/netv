...
export const TopRated: React.FC = () => {
  ...
  const { data, isLoading, isError, error, refetch } = useTopRatedMovies(page);
    ...
    <motion.div className="page-wrapper pt-20" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.4 }}>
      <div className="max-w-7xl mx-auto px-8 md:px-12 py-8">
        <div className="flex items-center gap-3 mb-8">
          <FiAward className="w-7 h-7 text-brand-red" />
          <h1 className="text-h1 font-bold text-white">Top Rated</h1>
        </div>
